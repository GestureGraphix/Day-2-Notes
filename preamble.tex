...
\definecolor{pastelExampleBg}{HTML}{A1EEBD} % Base pastel color
\definecolor{greenPast}{HTML}{86C8BC} % Base pastel color
\colorlet{myexamplebg}{pastelExampleBg!50!white} % Mix with white for a pastel color
\colorlet{myexamplefr}{pastelExampleBg!70!white} % Use the same mix for the frame
\colorlet{myexampleti}{greenPast!80!black} % Mix A1EEBD with black for a darker green
