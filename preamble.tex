...
\definecolor{pastelExampleBg}{HTML}{CFF6CF} % Base pastel color
\definecolor{greenPast}{HTML}{86C8BC} % Base pastel color
\colorlet{myexamplebg}{pastelExampleBg!60!white} % Mix with white for a pastel color
\colorlet{myexamplefr}{pastelExampleBg!90!black} % Use the same mix for the frame
