...
\newtcolorbox[auto counter, number within=section]{ExampleWithRose}[2][]{%
    ...
    enhanced,
    overlay={
        \node[anchor=south east] at (frame.south east) {\includegraphics[width=1.5cm]{vio.png}};
    },
    #1
}
...
\newtcolorbox{noteWithImage}[1][]{%
    ...
    overlay unbroken and last={
        \node[anchor=south east,xshift=-2mm,yshift=1mm] at (frame.south east) {\includegraphics[width=1cm]{rose.png}};
